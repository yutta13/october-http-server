...
public class CashWithdrawalProcessor implements RequestProcessor {
    Connection connection;
    private RequestProcessor defaultUnauthorizedProcessor;

    public CashWithdrawalProcessor(Connection connection) {
    ...
    public void execute(HttpRequest request, OutputStream output) throws IOException , DefaultInternalServerErrorProcessor{
        ...
        try {PreparedStatement preparedStatement = connection.prepareStatement(Db_queries.getCardPresentQuery(card_no));
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(Db_queries.getCWDforcardQuery(transAmount, card_no));
        ...
        String response = "" +
                ...
                "\r\n" +
                "<html><body><h1>" + "Успешное снятие наличных " + "</h1></body></html>";
